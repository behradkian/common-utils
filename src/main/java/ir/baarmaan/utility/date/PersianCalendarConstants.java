...
public class PersianCalendarConstants {
    ...
    public static final long PERSIAN_EPOCH = 1948321L;
    public static final String[] persianMonthNames = new String[]{"فروردین", "اردی\u200cبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"};
